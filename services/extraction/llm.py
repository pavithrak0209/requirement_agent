...
For EACH mandatory field, scan the ENTIRE input for implicit or indirect mentions:
  ...
  startDate
    Detect: any explicit start date for the work or sprint.
  ...
  dueDate
    Detect: any explicit deadline, end date, or sprint end.
    Examples: "due by end of sprint", "deadline May 1", "must be done by April 30"
    Format: YYYY-MM-DD or null if not mentioned.
...
- "startDate": string or null, start date in YYYY-MM-DD format — use MANDATORY FIELD DETECTION rules above
- "dueDate": string or null, due date or deadline in YYYY-MM-DD format — use MANDATORY FIELD DETECTION rules above
